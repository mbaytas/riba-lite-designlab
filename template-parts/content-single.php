...
<div class="link-wrapper">
    <div class="post-cover-wrapper">
            <?php if( has_post_thumbnail() ) {
                ...
                echo '<a href="'.esc_url( get_the_permalink() ).'" class="post-cover post-cover-'.get_the_ID().'">';
    ...
    <div class="container">
        <div class="row">
            <?php the_title( sprintf( '<h2 class="post-title col-lg-9 col-md-9 col-sm-9 col-xs-12"><a href="%s" rel="bookmark">', esc_url( get_permalink() ) ), '</a></h2>' ); ?>
